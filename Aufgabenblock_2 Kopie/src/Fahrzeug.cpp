...
Fahrzeug::Fahrzeug():Simulationsobject(){
}

Fahrzeug::Fahrzeug(string name):Simulationsobject(name){
	cout << "Fahrzeug: Name: "<< p_sName <<"\t->\tID: "<< p_iID <<"\t\tMaxGeschwindigkeit: "<< p_dMaxGeschwindigkeit << endl;
}

Fahrzeug::Fahrzeug(string name, double maxGeschw,bool createMsg,bool deleteMsg):Simulationsobject(name,createMsg,deleteMsg) {
